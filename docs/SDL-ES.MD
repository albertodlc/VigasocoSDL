...
VIGASOCOSDL es la versión para SDL del proyecto VIGASOCO.
Se ha probado en i386 GNU-Linux, PS3-PPC GNU-Linux , PlayStation2 en modo nativo(con restricciones), 
Mac OSX y Sega Dreamcast, aunque no debe ser dificil adaptarlo a cualquier otra plataforma con SDL y un compilador moderno de C++.
...
en varias webs durantes años sin problema alguno, VigasosoSDL se distribuye con 
los archivos necesarios para jugar a "La abadia del crimen".

Uso:
===

Similar a la versión Windows ( ver window_es.txt).
...
Cursores: cruzeta del pad o seta analógica izquierda
    Start: PAUSA
       L1: Cargar partida
       R1: Grabar partida
