...
protected:
  ...
  double _ticksPerSleepMiliSec;  // average of time elapsed for the lasts
                                 // sleep(1) calls
  double _ticksPerSleepMiliSec2; // average of time elapsed for the lasts
                                 // sleep(1) calls
  ...
  // methods
public:
  bool init(ITimer *t, int intsPerSecond, int intsPerVideoUpdate,
