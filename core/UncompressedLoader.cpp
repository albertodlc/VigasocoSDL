...
UINT8 *UncompressedLoader::load(std::string fileName, UINT32 fileSize,
                                UINT32 CRC32) {
...
void UncompressedLoader::dispose(UINT8 *ptr) { delete[] ptr; }

void UncompressedLoader::close() { _path = ""; }
