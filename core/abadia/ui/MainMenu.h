...
class MainMenu {
public:
  MainMenu(int language, Abadia::Pergamino *pergamino,
           Abadia::MotorGrafico *gameEngine, Abadia::Logica *gameLogic,
           Abadia::Controles *inputController, Abadia::Marcador *marcador,
           CPC6128 *cpc6128, TimingHandler *timer);
  ~MainMenu() = default;

  void setTimer(TimingHandler *timer) { _timer = timer; }
  void setInputController(Abadia::Controles *inputController) {
