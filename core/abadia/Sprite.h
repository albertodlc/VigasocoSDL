...
public:
  ...
  bool haCambiado; // indica si el sprite ha cambiado desde que se dibujó por
                   // última vez
  ...
  int posXPant;    // coordenada x del sprite en la pantalla (en múltiplos de 4
                   // pixels)
  int posYPant;    // coordenada y del sprite en la pantalla (en pixels)
  int oldPosXPant; // anterior coordenada x del sprite en la pantalla (en
                   // múltiplos de 4 pixels)
  int oldPosYPant; // anterior coordenada y del sprite en la pantalla (en
                   // pixels)
  ...
  int posXTile;   // coordenada x del tile en el que se empieza a dibujar el
                  // sprite (en múltiplos de 4 pixels)
  int posYTile;   // coordenada y del tile en el que se empieza a dibujar el
                  // sprite (en pixels)
...
public:
  ...
  // dibujo del sprite
  virtual void dibuja(Sprite *spr, UINT8 *bufferMezclas, int lgtudClipX,
...
private:
  void dibujaVGA(Sprite *spr, UINT8 *bufferMezclas, int lgtudClipX,
                 int lgtudClipY, int dist1X, int dist2X, int dist1Y,
                 int dist2Y);
};
