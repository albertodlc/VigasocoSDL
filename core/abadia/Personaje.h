...
protected:
  struct DatosFotograma {
    ...
    int ancho;  // ancho de este fotograma de la animación (en múltiplos de 4
                // pixels)
...
public:
  ...
  bool giradoEnDesnivel; // indica que el personaje no está avanzando en el
                         // sentido del desnivel
  bool flipX;            // indica si los gráficos están girados en x
  int despFlipX;         // desplazamiento de los gráficos girados en x
  int despX; // desplazamiento en x para dibujar el personaje (en múltiplos de 4
             // pixels)
  int despY; // desplazamiento en y para dibujar el personaje (en pixels)
  int valorPosicion; // valor a grabar en las posiciones de la rejilla en las
                     // que está el personaje

  bool puedeQuitarObjetos; // indica si el personaje puede quitar objetos o a
                           // otro personaje
