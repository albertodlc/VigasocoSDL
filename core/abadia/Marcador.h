...
public:
  ...
  int numPosScrollDia;     // número de posiciones para completar el scroll del
                           // nombre del día
...
public:
  ...
  void imprimeFrase(std::string frase, int x, int y, int colorTexto,
                    int colorFondo);
  void imprimirCaracter(int caracter, int x, int y, int colorTexto,
                        int colorFondo);
