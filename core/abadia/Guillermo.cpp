...
// VGA
Personaje::DatosFotograma Guillermo::tablaAnimacion[8] = {
    {54480, 0x05, 0x22}, {53760, 0x05, 0x24}, {54480, 0x05, 0x22},
    {55180, 0x05, 0x22}, {57240, 0x04, 0x21}, {55880, 0x05, 0x23},
    {57240, 0x04, 0x21}, {56580, 0x05, 0x21}};
...
void Guillermo::ejecutaMovimiento() {
  ...
  if (estado == 0) {
    ...
    if (laLogica->numPersonajeCamara != 0)
      return;
