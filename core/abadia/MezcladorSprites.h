// MezcladorSprites.h
//
//	Clase que representa al mezclador de los sprites. Esta clase se encarga
//de actualizar la 	pantalla generada mezclando los sprites entre las capas de
//tiles según la profundidad.
//
/////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  MezcladorSprites(GeneradorPantallas *generador, UINT8 *buffer,
                   int lgtudBuffer);
  ~MezcladorSprites();
...
protected:
  ...
  void dibujaTilesEntreProfundidades(Sprite *spr, int profMinX, int profMinY,
                                     int profMaxX, int profMaxY, int desp,
                                     bool ultimaPasada);
  ...
  // métodos de ayuda
  bool recortaSprite(int posVis, int lgtudVis, int pos, int lgtud,
                     int &lgtudClip, int &dist1, int &dist2);
