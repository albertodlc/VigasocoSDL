// PersonajeConIA.h
//
//	Clase que representa un personaje del juego que tiene inteligencia
//artificial
//
/////////////////////////////////////////////////////////////////////////////
...
class PersonajeConIA : public Personaje {
  // campos
public:
  int numBitAcciones; // indica el número de bits procesados del byte de
                      // acciones actual
  bool pensarNuevoMovimiento; // indica si hay que pensar un nuevo movimiento
  UINT8 accionActual; // indica las acciones que el personaje está procesando
                      // actualmente
  int posAcciones; // posición de la acción actual en el buffer de acciones del
                   // personaje
  ...
  int mascarasPuertasBusqueda; // máscara de las puertas que se comprobarán en
                               // la búsqueda
...
protected:
  static UINT16
      comandosGirar[4][2]; // tabla con los comandos para cambiar de orientación
  static UINT16 comandosAvanzar[5][2]; // tabla con los comandos para avanzar
  static int bufferDatosPersonaje[10]; // buffer para guardar los datos del
                                       // personaje por si hay que deshacer
  static int distanciasOri[4][4]; // tabla con las distancias permisibles según
                                  // la orientación
