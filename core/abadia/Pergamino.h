...
public:
  ...
  // static const char *pergaminoInicio[8];	// texto del pergamino de la
  // presentación del juego
  static const unsigned char
      *pergaminoInicio[8]; // texto del pergamino de la presentación del juego
  // static const char *pergaminoFinal[8];	// texto del pergamino del final
  // del juego
  static const unsigned char
      *pergaminoFinal[8]; // texto del pergamino del final del juego
  static const unsigned char
      *pergaminoReferencias[8]; // texto del pergamino del final del juego
  // no esta definido el caracter 5 en el pergamino y no podemos , por ejemplo,
  // poner el texto para F5
  //	static const unsigned char *pergaminoAyudasyMejoras[8];	// texto del
  //pergamino del final del juego
  static const unsigned char
      *pergaminoManejo[8]; // texto del pergamino del manejo del teclado
  static const unsigned char
      *pergaminoIntroduccion[8]; // texto del pergamino del manejo del teclado

protected:
  CPC6128 *cpc6128; // objeto que presta ayuda para realizar operaciones
                    // gráficas del cpc6128
  UINT8 *roms;
