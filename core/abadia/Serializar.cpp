...
std::ofstream &Abadia::operator<<(std::ofstream &out,
...
std::ifstream &Abadia::operator>>(std::ifstream &in, PosicionJuego *const pos) {
...
std::ofstream &Abadia::operator<<(std::ofstream &out, const Objeto *const obj) {
  int j;
  ...
  for (j = Juego::numPersonajes - 1;
       (obj->personaje != elJuego->personajes[j] && j >= 0); j--)
    ;
  out << j << "// numPersonaje\n";
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Objeto *const obj) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
  int tmp;
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Puerta *const puerta) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Sprite *const sprite) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Personaje *const pers) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in,
...
std::ofstream &Abadia::operator<<(std::ofstream &out, const Adso *const adso) {
  out << "// ADSO\n";
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Adso *const adso) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ofstream &Abadia::operator<<(std::ofstream &out, const Abad *const abad) {
  out << "// ABAD" << std::endl;
  ...
  out << abad->guillermoHaCogidoElPergamino
      << "// guillermoHaCogidoElPergamino\n";

  return out;
}

std::ifstream &Abadia::operator>>(std::ifstream &in, Abad *const abad) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Severino *const severino) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Jorge *const jorge) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Bernardo *const bernardo) {
  std::streamsize intMAX = std::numeric_limits<int>::max();
...
std::ifstream &Abadia::operator>>(std::ifstream &in, Logica *const logica) {
  Guillermo *guillermo;   // guillermo
  Adso *adso;             // adso
  Malaquias *malaquias;   // malaquias
  Abad *abad;             // el abad
