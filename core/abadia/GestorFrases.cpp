...
const char *GestorFrases::frases[8][0x38 + 1] = {
    {
        // 0 Castellano
        "SECRETUM FINISH AFRICAE, MANUS SUPRA XXX AGE PRIMUM ET SEPTIMUM DE "
        "QUATOR",
        "BIENVENIDO A ESTA ABADIA, HERMANO. OS RUEGO QUE ME SIGAIS. HA "
        "SUCEDIDO ALGO TERRIBLE",
        "TEMO QUE UNO DE LOS MONJES HA COMETIDO UN CRIMEN. OS RUEGO QUE LO "
        "ENCONTREIS ANTES DE QUE LLEGUE BERNARDO GUI, PUES NO DESEO QUE SE "
        "MANCHE EL NOMBRE DE ESTA ABADIA",
        "DEBEIS RESPETAR MIS ORDENES Y LAS DE LA ABADIA. ASISTIR A LOS OFICIOS "
        "Y A LA COMIDA. DE NOCHE DEBEIS ESTAR EN VUESTRA CELDA",
        ...
        "DEBEIS SABER QUE LA BIBLIOTECA ES UN LUGAR SECRETO. SOLO MALAQUIAS "
        "PUEDE ENTRAR. PODEIS IROS",
        "OREMOS",
        "HERMANOS, BERENGARIO HA DESAPARECIDO. TEMO QUE SE HAYA COMETIDO OTRO "
        "CRIMEN",
        ...
        "MALAQUIAS HA MUERTO",
        "SOIS VOS, GUILERMO... PASAD, OS ESTABA ESPERANDO. TOMAD, AQUI ESTA "
        "VUESTRO PREMIO",
        "ESTAIS MUERTO, FRAY GUILLERMO, HABEIS CAIDO EN LA TRAMPA",
        "VENERABLE JORGE, VOIS NO PODEIS VERLO, PERO MI MAESTRO LLEVA GUANTES. "
        "PARA SEPARAR LOS FOLIOS TENDRIA QUE HUMEDECER LOS DEDOS EN LA LENGUA, "
        "HASTA QUE HUBIERA RECIBIDO SUFICIENTE VENENO",
        "SE ESTA COMIENDO EL LIBRO, MAESTRO",
        "DEBEIS ABANDONAR YA LA ABADIA",
        "ES MUY EXTRAÑO, HERMANO GUILLERMO. BERENGARIO TENIA MANCHAS NEGRAS EN "
        ...
        "ES EL COENA CIPRIANI DE ARISTOTELES. AHORA COMPRENDEREIS POR QUE "
        "TENIA QUE PROTEGERLO. CADA PALABRA ESCRITA POR EL FILOSOFO HA "
        "DESTRUIDO UNA PARTE DEL SABER DE LA CRISTIANDAD. SE QUE HE ACTUADO "
        "SIGUIENDO LA VOLUNTAD DEL SEÑOR... LEEDLO, PUES, FRAY GUILLERMO. "
        "DESPUES TE LO MOSTRARE A TI MUCHACHO",
        "FUE UNA BUENA IDEA ¿VERDAD?; PERO YA ES TARDE",
        "QUIERO QUE CONOZCAIS AL HOMBRE MAS VIEJO Y SABIO DE LA ABADIA",
        "VENERABLE JORGE, EL QUE ESTA ANTE VOS ES FRAY GUILLERMO, NUESTRO "
        "HUESPED",
        "SED BIENVENIDO, VENERABLE HERMANO; Y ESCUCHAD LO QUE OS DIGO. LAS "
        "VIAS DEL ANTICRISTO SON LENTAS Y TORTUOSAS. LLEGA CUANDO MENOS LO "
        "ESPERAS. NO DESPERDICIEIS LOS ULTIMOS DIAS",
        ...
        "VENERABLE HERMANO, SOY SEVERINO, EL ENCARGADO DEL HOSPITAL. QUIERO "
        "ADVERTIROS QUE EN ESTA ABADIA SUCEDEN COSAS MUY EXTRAÑAS. ALGUIEN NO "
        "QUIERE QUE LOS MONJES DECIDAN POR SI SOLOS LO QUE DEBEN SABER"
    ...
    {       // 1 Inglés
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "WELCOME TO THIS ABBEY, BROTHER. I BEG YOU TO FOLLOW ME. SOMETHING "
     "HORRIBLE HAS HAPPENED",
     "I AM AFRAID THAT ONE OF THE MONKS HAS COMMITTED A MURDER. I BEG YOU TO "
     "FIND HIM BEFORE BERNARD GUI ARRIVES, AS I DO NOT WISH THE NAME OF THIS "
     "ABBEY TO BE STAINED.",
     "YOU MUST RESPECT MY ORDERS AND THE ONES OF THE ABBEY. ATTEND THE OFFICES "
     "AND MEAL. AT NIGHT YOU MUST BE IN YOUR CELL.",
     ...
     "YOU MUST KNOW THAT THE LIBRARY IS A SECRET PLACE. JUST MALACHIA CAN GO "
     "IN. YOU MAY GO.",
     "OREMUS",
     "BROTHERS, BERENGAR HAS DISAPPEARED. I AM AFRAID ANOTHER MURDER HAS BEEN "
     "COMMITTED.",
     ...
     "MALACHIA IS DEAD",
     "IS IT YOU, WILLIAM... COME IN, I WAS WAITING FOR YOU. TAKE THIS, HERE IS "
     "YOUR REWARD",
     "YOU ARE DEAD, BROTHER WILLIAM. YOU FELL INTO THE TRAP",
     "VENERABLE JORGE, YOU CANNOT SEE IT, BUT MY MASTER IS WEARING GLOVES. IN "
     "ORDER TO SEPARATE THE SHEETS HE SHOULD DAMPEN HIS FINGERS WITH HIS "
     "TONGUE, UNTIL HE HAD RECEIVED ENOUGH POISON",
     "HE IS EATING THE BOOK, MASTER",
     "YOU MUST LEAVE THE ABBEY",
     "IT IS VERY STRANGE, BROTHER WILLIAM. BERENGAR HAD BLACK STAINS ON HIS "
     "TONGUE AND FINGERS",
     ...
     "IT IS THE COENA CIPRIANI OF ARISTOTLE. NOW YOU WILL UNDERSTAND WHY I HAD "
     "TO PROTECT IT. EACH WORD WRITTEN BY THE PHILOSOPHER HAS DESTROYED A PART "
     "OF THE KNOWLEDGE OF CHRISTENDOM. "
     "I KNOW I HAVE ACTED FOLLOWING THE WILL OF GOD. READ IT, THEN, BROTHER "
     "WILLIAM. AFTER THAT I WILL SHOW IT TO YOU, KID.",
     ...
     "BE WELCOME, VENERABLE BROTHER; AND LISTEN WHAT I TELL YOU. THE "
     "ANTICHRIST MEANS ARE SLOW AND TORTUOUS. HE COMES WHEN YOU DO NOT EXPECT. "
     "DO NOT WASTE THE LAST DAYS",
     ...
     "VENERABLE BROTHER, I AM SEVERINUS, THE RESPONSIBLE FOR THE HOSPITAL. I "
     "WANT TO WARN YOT THAT VERY STRANGE THINGS HAPPEN IN THIS ABBEY. SOMEONE "
     "DOES NOT WANT THE MONKS TO DECIDE BY THEMSELVES WHAT THEY HAVE TO KNOW.",
     " "}, // Fin textos 1 ingles
    {      // 2 Brasil
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "BEM-VINDO A ESTA ABADIA, IRMÃO. ROGO QUE ME SIGAS. ACONTECEU ALGO "
     "TERRÍVEL",
     "TEMO QUE UM DOS MONGES TENHA COMETIDO UM CRIME. ROGO-TE QUE O ENCONTRES "
     "ANTES QUE BERNARDO GUI CHEGUE, POIS NÃO DESEJO QUE SE MANCHE O NOME "
     "DESTA ABADIA",
     "DEVES RESPEITAR MINHAS ORDENS E AS REGRAS DA ABADIA; ASSISTIR AOS "
     "OFÍCIOS E ÀS REFEIÇÕES. À NOITE, DEVES ESTAR EM TUA CELA",
     ...
     "DEVES SABER QUE A BIBLIOTECA É UM LUGAR SECRETO. SOMENTE MALAQUIAS PODE "
     "ENTRAR. PODES IR",
     "OREMOS",
     ...
     "ES TU, GUILHERME... PASSA, ESTAVA TE ESPERANDO. TOMA, AQUI ESTÁ TEU "
     "PRÊMIO",
     "ESTÁS MORTO, FREI GUILHERME, CAÍSTE NA ARMADILHA",
     "VENERÁVEL JORGE, NÃO PODES VER, MAS MEU MESTRE USA LUVAS. PARA SEPARAR "
     "AS FOLHAS, TERIA QUE UMEDECER OS DEDOS NA LÍNGUA ATÉ QUE TIVESSE "
     "RECEBIDO VENENO SUFICIENTE",
     "ESTÁ COMENDO O LIVRO, MESTRE",
     "DEVES ABANDONAR A ABADIA",
     "É MUITO ESTRANHO, IRMÃO GUILHERME. BERENGÁRIO TINHA MANCHAS NEGRAS NA "
     "LÍNGUA E NOS DEDOS",
     ...
     "É O COENA CIPRIANI DE ARISTÓTELES. AGORA COMPREENDES POR QUE TINHA QUE "
     "PROTEGÊ-LO. CADA PALAVRA ESCRITA PELO FILÓSOFO DESTRUIU UMA PARTE DO "
     "SABER DA CRISTANTADE. SEI QUE AGI SEGUINDO A VONTADE DO SENHOR... "
     ...
     "SÊ BEM-VINDO, VENERÁVEL IRMÃO; E ESCUTA BEM O QUE TE DIGO. OS CAMINHOS "
     "DO ANTI-CRISTO SÃO LENTOS E TORTUOSOS. CHEGA QUANDO MENOS O ESPERAS. NÃO "
     "DESPERDICES OS ÚLTIMOS DIAS",
     ...
     "VENERÁVEL IRMÃO, SOU SEVERINO, O ENCARREGADO DA ENFERMARIA. QUERO "
     "ADVERTI-LO QUE NESTA ABADIA ACONTECEM COISAS MUITO ESTRANHAS. ALGUÉM NÃO "
     "QUER QUE OS MONGES DECIDAM POR SI SÒ O QUE DEVEM SABER",
     " "}, // Fin textos 2 Brasil
    {      // 3 Catalan
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "BENVINGUT A AQUESTA ABADIA, GERMÀ. US PREGO QUE EM SEGUIU. HA SUCCEIT "
     "QUELCOM TERRIBLE",
     "EM TEMO QUE UN DELS MONJOS HA COMÉS UN CRIM. US PREGO QUE EL TROBEU "
     "ABANS QUE ARRIBI BERNAT GUI, DONCS NO DESITJO QUE TAQUI EL NOM D'AQUESTA "
     "ABADIA",
     "HEU DE RESPECTAR LES MEVES ORDRES I LES DE L'ABADIA. ASSISTIR ALS OFICIS "
     "I AL DINAR. DE NIT HEU D'ESTAR A LA VOSTRA CEL.LA",
     ...
     "HEU DE SABER QUE LA BIBLIOTECA ÉS UN LLOC SECRET. NOMÉS MALAQUIES POT "
     "ENTRAR. PODEU MARXAR.",
     "PREGUEM",
     ...
     "MALAQUIES HA MORT",
     "SOU VOS, GUILLEM... PASSEU, US ESTAVA ESPERANT. TENIU, AQUÍ TENIU EL "
     "VOSTRE PREMI",
     "ESTEU MORT, FRA GUILLEM. HEU CAIGUT A LA TRAMPA",
     "VENERABLE JORDI, VOS NO PODEU VEURE-HO, PERO EL MEU MESTRE PORTA GUANTS. "
     "PER A SEPARAR ELS FOLIS HAURIA D' HUMITEJAR ELS DITS A LA LLENGUA, FINS "
     "QUE HAGUÉS REBUT PROU VERÍ",
     "S'ESTÀ MENJANT EL LLIBRE, MESTRE",
     "HEU D'ABANDONAR L'ABADIA",
     "ES MOLT ESTRANY, GERMÀ GUILLEM. BERENGUER TENIA TAQUES NEGRES A LA "
     "LLENGUA I ALS DITS",
     ...
     "ÉS EL COENA CIPRIANI D'ARISTÒTIL. ARA COMPRENDREU PER QUÈ HAVIA DE "
     "PROTEGIR-LO. CADA PARAULA ESCRITA PEL FILÒSOF HA DESTRUÏT UNA PART DEL "
     "SABER DE LA CRISTIANDAT. "
     "SÉ QUE HE ACTUAT SEGUINT LA VOLUNTAT DEL SENYOR... LLEGIU-LO, DONCS, FRA "
     "GUILLEM. DESPRÉS T'HO DEMOSTRARÉ A TU NOI",
     ...
     "SIGUEU BENVINGUT, VENERABLE GERMÀ; I ESCOLTEU EL QUE US DIC. LES VIES DE "
     "L'ANTICRIST SON LENTES I TORTUOSES. ARRIBA QUAN MENYS HO ESPERES. NO "
     "MALGASTEU ELS DARRERS DIES ",
     ...
     "VENERABLE GERMÀ, SÓC SEVERÍ, L'ENCARREGAT DE L'HOSPITAL. VULL "
     "ADVERTIR-VOS QUE A AQUESTA ABADIA SUCCEEIXEN COSES MOLT EXTRANYES. ALGÚ "
     "NO VOL QUE ELS MONJOS DECIDEIXIN PER SI SOLS EL QUE HAN DE SABER",
     " "}, // Fin textos 3 Catalan
    {      // 4 Gallego
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "BENVIDO A ESTA ABADÍA, IRMÁN. PRÉGOVOS QUE ME SIGADES. ACONTECEU ALGO "
     "TERRIBLE",
     "TÉMOME QUE UN DOS MONXES COMETERA UN CRIME. PRÉGOVOS QUE O ATOPEDES "
     "ANTES DE QUE CHEGUE BERNARDO GUI, POIS NON É O MEU DESEXO QUE SE MANCHE "
     "O NOME DESTA ABADÍA",
     "DEBEDES RESPECTA-LAS MIÑAS ORDES E AS DA ABADÍA. ASISTIR ÓS OFICIOS E Ó "
     "XANTAR. DE NOITE DEBEDES FICAR NA VOSA CELA",
     ...
     "DEBEDES SABER QUE A BIBLIOTECA É UN LUGAR SEGREDO. SÓ MALAQUÍAS PODE "
     "ENTRAR. PODEDES IRVOS.",
     "OREMOS",
     ...
     "MALAQUIAS MORREU",
     "SODES VOS, GUILLERME... PASADE, ESTABAVOS AGARDANDO. TOMADE, AQUI ESTA O "
     "VOSO GALARDÓN",
     "ESTADES MORTO, FRAI GUILLERME. CAÉSTEDES NA TRAMPA",
     "VENERABLE XURXO, VOS NON PODEDES VELO, PERO O MEU MESTRE LEVA UNHAS "
     "LUVAS. PRA SEPARA-LOS FOLIOS TERÍA QUE HUMEDECE-LOS DEDOS NA LINGUA, ATA "
     "QUE RECIBIRA VELENO ABONDO",
     "ESTA A COME-LO LIBRO, MESTRE",
     "DEBEDES ABANDONA-LA ABADÍA",
     "ABOFÉ QUE É EXTRAÑO, IRMÁN GUILLERME. BERENGARIO TIÑA MANCHAS NEGRAS NA "
     "LINGUA E NOS DEDOS",
     ...
     "É O COENA CIPRIANI DE ARISTÓTELES. AGORA COMPRENDEREDES POR QUE TIÑA QUE "
     "PROTEXELO. CADA PALABRA ESCRITA POLO FILÓSOFO FIXO ANACOS UNHA PARTE DO "
     "SABER DA CRISTIANDADE. "
     "SEI QUE OBREI SIGUINDO A VONTADE DO SEÑOR... LEDEO, POIS, FRAI "
     "GUILLERME. DESPOIS MOSTRAREICHO A TI RAPAZ",
     ...
     "SEDE BENVIDO, VENERABLE IRMÁN; E ESCOITADE O QUE VOS DIGO. AS VIAS DO "
     "ANTICRISTO SONVOS LENTAS E TORTUOSAS. CHEGA CANDO MENOS O ESPERAS. NON "
     "MALGASTEDES OS DERRADEIROS DÍAS",
     ...
     "VENERABLE IRMÁN, SON SEVERINO, O ENCARGADO DO HOSPITAL. QUERO PREVIRVOS "
     "QUE NESTA ABADÍA ACONTECEN COUSAS MOI EXTRANAS. ALGUÉN NON DESEXA QUE OS "
     "MONXES DECIDAN POR SI SÓS O QUE DEBEN DE SABER",
     " "

    }, // Fin textos 4 Gallego
    {  // 5 Italiano
     "SECRETUM FINIS AFRICAE, MANUS SUPRA  AAA IDOLUM AGE PRIMUM ET SEPTIMUM "
     "DE QUATUOR",
     "BENVENUTO A QUESTA ABBAZIA, FRATELLO. VI PREGO DI SEGUIRMI. QUALCOSA DI "
     "TERRIBILE É ACCADUTO",
     "TEMO CHE UNO DEI MONACI ABBIA COMMESSO UN CRIMINE. VI PREGO DI "
     "INCONTRARLO PRIMA CHE ARRIVI BERNARDO GUI, POICHÉ NON DESIDERO CHE IL "
     "NOME DI QUESTA ABBAZIA SI MACCHI",
     "DOVETE RISPETTARE I MIEI ORDINI E QUELLI DELLA ABBAZIA. PARTECIPARE ALLE "
     "FUNZIONI E AI PASTI. DI NOTTE DOVETE RESTARE NELLA VOSTRA CELLA",
     ...
     "NON AVETE RISPETTATO I MIEI ORDINI. ABBANDONATE PER SEMPRE QUESTA "
     "ABBAZIA",
     ...
     "DOVETE SAPERE CHE LA BIBLIOTECA È UN LUOGO SEGRETO. SOLO MALACHIA PUÒ "
     "ENTRARE. POTETE ANDARE",
     "PREGHIAMO",
     "FRATELLI, BERENGARIO È SCOMPARSO. TEMO CHE SIA STATO COMMESSO UN ALTRO "
     "CRIMINE",
     ...
     "MALACHIA È MORTO",
     "SIETE VOI, GUGLIELMO... PASSATE, VI STAVO ASPETTANDO. PRENDETE, QUESTO È "
     "IL VOSTRO PREMIO",
     "SIETE MORTO, FRATE GUGLIELMO. SIETE CADUTO NELLA TRAPPOLA",
     "VENERABILE JORGE, VOI NON POTETE VEDERLO, MA IL MIO MAESTRO PORTA I "
     "GUANTI. PER SEPARARE I FOGLI DOVREBBE INUMIDIRE LE DITA CON LA LINGUA, "
     "FINO AD AVER INGERITO SUFFICIENTE VELENO",
     "SI STA MANGIANDO IL LIBRO, MAESTRO",
     "DOVETE ABBANDONARE L'ABBAZIA",
     "È MOLTO STRANO, FRATE GUGLIELMO, BERENGARIO AVEVA MACCHIE NERE SULLA "
     "LINGUA E SULLE DITA",
     ...
     "È IL COENA CYPRIANI DI ARISTOTELE. ORA CAPIRETE PERCHÉ DOVEVO "
     "PROTEGGERLO. OGNI PAROLA SCRITTA DAL FILOSOFO HA DISTRUTTO UNA PARTE DEL "
     "SAPERE DELLA CRISTIANITÀ. SO DI AVER AGITO SEGUENDO LA VOLONTÀ DEL "
     "SIGNORE... "
     ...
     "VENERABILE JORGE, COLUI CHE STA DAVANTI A VOI È FRATE GUGLIELMO, NOSTRO "
     "OSPITE",
     "SIETE IL BENVENUTO, VENERABILE FRATELLO; E ASCOLTATE QUELLO CHE VI DICO. "
     "LE VIE DELL'ANTICRISTO SONO LENTE E TORTUOSE. ARRIVA QUANDO MENO LO SI "
     "ASPETTA. NON SPRECATE GLI ULTIMI GIORNI",
     ...
     "VENERABILE FRATELLO, SONO SEVERINO, L'INCARICATO DELL'OSPEDALE. VOGLIO "
     "AVVERTIRVI CHE IN QUESTA ABBAZIA CAPITANO COSE MOLTO STRANE. QUALCUNO "
     "NON VUOLE CHE I MONACI DECIDANO DA SOLI QUELLO CHE DEVONO SAPERE",
     " "}, // Fin textos 5 Italiano
    {      // 6 Fines
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "TERVETULOA LUOSTARIIMME VELI. PYYDÄN TEITÄ SEURAAMAAN MINUA. JOTAIN "
     "KAUHEAA ON TAPAHTUNUT",
     "PELKÄÄN YHDEN MUNKEISTAMME SYYLLISTYNEEN MURHAAN. PYYDÄN, ETSIKÄÄ "
     "MURHAAJA ENNEN BERNARD GUIN SAAPUMISTA, JOTTA LUOSTARIMME NIMI EI "
     "TAHRIINTUISI VEREEN.",
     "TEIDÄN TULEE KUNNIOITTAMAN MINUN KÄSKYJÄNI JA TÄMÄN LUOSTARIN SÄÄNTÖJÄ. "
     "OSALLISTUKAA PALVELUKSIIN JA ATERIOILLE. YÖT TEIDÄN TULEE VIETTÄMÄN "
     "KAMMIOISSANNE.",
     "JÄTTÄKÄÄ VENANTIUKSEN KÄSIKIRJOITUS RAUHAAN TAI KERRON TOIMISTANNE "
     "APOTTILLE.",
     ...
     "TIEDÄ, ETTÄ KIRJASTO ON SALATTU PAIKKA JA VAIN MALACHIAS VOI LIIKKUA "
     "SIELLÄ. PALATKAA TOIMIINNE.",
     "RUKOILKAAMME",
     ...
     "SINÄKÖ SE OLET, VELI WILLIAM... TULE SISÄÄN, ODOTIN SINUA. OTA TÄMÄ, SE "
     "ON PALKKIOSI.",
     "LANKESIT ANSAAN JA KUOLEMA ON OLEVA LOPULLINEN PALKKIOSI VELI WILLIAM.",
     "KUNNIOITETTU JORGE, ETTE VOI NÄHDÄ MESTARINI KÄYTTÄVÄN HANSIKKAITA. "
     "EROTTAAKSEEN SIVUT TOISISTAAN HÄNEN TULISI KOSTUTTAA SORMENPÄÄNSÄ "
     "KIELELLÄÄN KUNNES KIRJASTA OLISI VÄLITTYNYT TARPEEKSI MYRKKYÄ.",
     "MESTARINI, HÄN SYÖ KIRJAN SIVUJA",
     "TEIDÄN TÄYTYY LÄHTEÄ LUOSTARISTA.",
     "OUTOA VELI WILLIAM. BERENGARILLA OLI TUMMIA LÄIKKIÄ KIELESSÄÄN JA "
     "SORMENPÄISSÄÄN.",
     ...
     "SE ON ARISTOTELEEN COENA CYPRIANI. NYT YMMÄRRÄTTE MIKSI MINUN PITI "
     "SUOJELLA SITÄ. "
     "JOKAINEN TUON FILOSOFIN KIRJOITTAMA SANA ON TUHONNUT KRISTIKUNNAN "
     "KERÄÄMÄÄ TIETOA. TIEDÄN TOIMINEENI JUMALAN ARMOSSA. LUE VAIN VELI "
     "WILLIAM, SELAILE KIRJAA. OLET ANSAINNUT SEN. NÄYTÄN SEN VIELÄ "
     "SINULLEKIN, NOVIISI.",
     "SE OLI HYVÄ IDEA, EIKÖ OLLUTKIN? MUTTA NYT ON LIIAN MYÖHÄISTÄ.",
     "HALUAN TAVATA LUOSTARIN VANHIMMAN JA VIISAIMMAN MIEHEN.",
     "KUNNIOITETTU JORGE, MUNKKI EDESSÄNNE ON VELI WILLIAM, JOKA ON "
     "VIERAANAMME.",
     "OLE TERVETULLUT KUNNIOITETTU VELI JA KUUNTELE KERTOMUSTANI. ANTIKRISTUS "
     "TOIMII HITAASTI JA KIERTELEMÄLLÄ. HÄN TULEE SILLOIN KUN SITÄ VÄHITEN "
     "ODOTAMME. ÄLÄ TUHLAA VIIMEISIÄ PÄIVIÄ ENNEN ANTIKRISTUSTA.",
     ...
     "KUNNIOITETTU VELI, OLEN SEVERINUS JA VASTUUSSA SAIRASTUVASTA. "
     "LUOSTARISSA ON TAPAHTUNUT HYVIN OUTOJA ASIOITA. JOKU EI HALUA MUNKKIEN "
     "PÄÄTTÄVÄN ITSE TIEDONJANONSA RAJOISTA.",
     " "}, // Fin textos 6 Fines
    {      // 7 Portugues
     "SECRETUM FINIS AFRICAE, MANUS SUPRA AAA IDOLUM AGE PRIMUM ET SEPTIMUM DE "
     "QUATUOR",
     "BEM-VINDO A ESTA ABADIA, IRMÃO. ROGO-VOS QUE ME SIGAIS. ACONTECEU ALGO "
     "TERRÍVEL.",
     "TEMO QUE UM DOS MONGES TENHA COMETIDO UM CRIME. ROGO-VOS QUE O "
     "ENCONTREIS ANTES QUE CHEGUE BERNARDO GUI, POIS NÃO DESEJO QUE SE MANCHE "
     "O NOME DESTA ABADIA",
     "DEVEIS RESPEITAR AS MINHAS ORDENS E AS DA ABADIA. ASSISTIR AOS OFÍCIOS E "
     "ÀS REFEIÇÕES. DE NOITE DEVEREIS ESTAR NA VOSSA CELA",
     ...
     "NÃO HAVEIS RESPEITADO AS MINHAS ORDENS. ABANDONAI PARA SEMPRE ESTA "
     "ABADIA.",
     ...
     "IRMÃOS, VENÂNCIO FOI ASSASSINADO.",
     "DEVEIS SABER QUE A BIBLIOTECA É UM LUGAR SECRETO. SÓ MALAQUIAS PODE "
     "ENTRAR. PODEIS IR-VOS.",
     "OREMOS",
     ...
     "ERA VERDADE, TINHA O PODER DE MIL ESCORPIÕES",
     "MALAQUIAS ESTÁ MORTO",
     "SOIS VÓS, GUILHERME... PASSAI, ESTAVA-VOS ESPERANDO. TOMAI, AQUI ESTÁ O "
     "VOSSO PRÉMIO",
     "ESTAIS MORTO, FREI GUILHERME. HAVEIS CAÍDO NA ARMADILHA.",
     "VENERÁVEL JORGE, VOS NÃO PODEIS VÊ-LO, MAS O MEU MESTRE CALÇA LUVAS. "
     "PARA SEPARAR OS FÓLIOS TINHA QUE HUMEDECER OS DEDOS NA LÍNGUA, ATÉ QUE "
     "TIVESSE RECEBIDO SUFICIENTE VENENO",
     ...
     "É O COENA CIPRIANI DE ARISTÓTELES. AGORA COMPREENDEREIS POR QUE TINHA "
     "QUE PROTEGÊ-LO. CADA PALAVRA ESCRITA "
     "PELO FILOSOFO DESTRUIU UMA PARTE DO SABER DA CRISTANDADE. SEI QUE ACTUEI "
     "SEGUINDO A VONTADE DO SENHOR... LEDE-O POIS, FREI GUILHERME. DEPOIS "
     "MOSTRÁLO-EI A TI RAPAZ.",
     ...
     "SEDE BEM-VINDO, VENERÁVEL IRMÃO; E ESCUTAI O QUE VOS DIGO. AS VIAS DO "
     "ANTICRISTO SÃO LENTAS E TORTUOSAS. CHEGA QUANDO MENOS O ESPERAS. NÃO "
     "DESPERDICEIS OS ÚLTIMOS DIAS",
     "LAMENTO, VENERÁVEL IRMÃO, NÃO PODEIS SUBIR À BIBLIOTECA",
     "SE O DESEJAIS, BERENGÁRIO MOSTRAR-VOS-Á O SCRIPTORIUM",
     "AQUI TRABALHAM OS MELHORES COPISTAS DO OCIDENTE",
     "AQUI TRABALHAVA VENÂNCIO",
     "VENERÁVEL IRMÃO, SOU SEVERINO, O ENCARREGADO DO HOSPITAL. QUERO "
     "ADVERTIR-VOS QUE NESTA ABADIA SUCEDEM COISAS MUITO ESTRANHAS. ALGUÉM NÃO "
     "QUER QUE OS MONGES DECIDAM POR SI PRÓPRIOS O QUE DEVEM SABER",
...
void GestorFrases::dibujaFrase(int numFrase) {
  ...
  // si se va a mostrar la frase del pergamino, cambia el puntero ya que en C++
...
void GestorFrases::procesaFraseActual() {
  ...
  if (!fraseTerminada) {
    ...
    // char32_t codePoint=0; // en la rama abadIA compilamos con -std=c++11 que
    // en uchar.h define char32_t para la rama master de VigasocoSDL usamos los
    // tipos de Vigasoco definidos en core/Types.h y eliminamos dependencias ya
    // que queremos compilar VigasocoSDL en diversos sistemas que igual solo
    // tienen un compilador C++ básico y SDL
    UINT32 codePoint = 0;
    ...
    // realiza el scroll de la frase que se muestra en el marcador e imprime el
    // nuevo carácter
    scrollFrase();
    ...
    // si la frase se ha terminado y solo se están poniendo espacios para que se
    // borre del marcador
    espaciosParaFin--;

    if (espaciosParaFin != 0) {
      // si el marcador está limpiándose, realiza el scroll y muestra espacios
      // en blanco
      scrollFrase();
...
void GestorFrases::scrollFrase() {
  ...
  // 10 líneas de alto
  for (int j = -2; j < 8; j++) {
    // desplaza 120/8 = 15 caracteres a la izquierda 1 caracter (cada caracter
    // es de 8x8)
    for (int i = 0; i < 120; i++) {
