...
/////////////////////////////////////////////////////////////////////////////
// métodos para indicar las posiciones a las que hay que ir según la orientación
// a coger
/////////////////////////////////////////////////////////////////////////////

// marca el rango de posiciones especificado como destino de la búsqueda
void FijarOrientacion::marcaPosiciones(RejillaPantalla *rejilla, int posX,
                                       int posY, int incX, int incY) {
  for (int i = 0; i < 16; i++) {
