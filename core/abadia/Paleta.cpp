...
int Paleta::introPalette[16] = {07, 20, 11, 03, 06, 12, 04, 21,
                                13, 05, 14, 29, 00, 28, 31, 27};
...
int Paleta::despPaletasVGA[6] = {
    -1, // paleta negra , en realidad no la tenemos en fichero y la generamos en
        // codigo
    0xC00, // paleta del pergamino TODO: FALTA POR COMPROBAR QUE ESTA PALETA ES
           // PARA EL PERGAMINO
    0,     // paleta de día durante el juego
    0x400, // paleta de noche durante el juego
    0x800, // paleta lampara TODO: FALTA HACER CAMBIOS EN EL CODIGO PARA QUE LA
           // USE
