...
void FileLoader::addLoader(ILoader *l) { _loaders.push_back(l); }

void FileLoader::removeLoader(ILoader *l) { _loaders.remove(l); }

void FileLoader::addPath(std::string path) { _paths.push_back(path); }
