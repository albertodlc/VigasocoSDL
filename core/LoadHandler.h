...
//		* preProcess is called before any file has been loaded in order
//to do 		any specific pre processing.
//		* load is called once for each file. The handler has to update
//the internal 		game data entity memory copying the file data.
//		* postProcess is called after all files have been loaded in
//order to do 		any specific post processing.
//
/////////////////////////////////////////////////////////////////////////////
