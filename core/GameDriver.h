...
class IAudioPlugin; // defined in video/IAudioPlugin.h
...
public:
  ...
  int getNumInterruptsPerVideoUpdate() const {
    return _numInterruptsPerVideoUpdate;
  }
  int getnumInterruptsPerLogicUpdate() const {
    return _numInterruptsPerLogicUpdate;
  }
