...
//		* open is called in order to do any necessary intialization when
//opening 		a file or folder (for example, reading a zip header).
//		* load is called once for each file to load. Load should return
//0 if 		it can't load the file, or a pointer to the allocated memory (the 		memory
