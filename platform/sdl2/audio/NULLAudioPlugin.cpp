...
void NULLAudioPlugin::end() { _isInitialized = false; }
...
bool NULLAudioPlugin::LoadWAV(const char *file) { return true; }
...
const unsigned int NULLAudioPlugin::g_paramTypes[] = {PARAM_ARRAY |
                                                      PARAM_INPUT};
...
int NULLAudioPlugin::getProperty(std::string prop) const { return -1; };
