...
public:
  ...
  virtual ~SDLDrawPlugin8bpp() {
    if (_font)
      TTF_CloseFont(_font); // ← clean up font on destroy
    SDL_DestroyMutex(cs);
  }
...
template <class T> class SDLDrawPluginFullScreen : public T {
public:
...
typedef SDLDrawPluginFullScreen<SDLDrawPlugin16bpp>
    SDLDrawPluginFullScreen16bpp;
typedef SDLDrawPluginFullScreen<SDLDrawPlugin24bpp>
    SDLDrawPluginFullScreen24bpp;
typedef SDLDrawPluginFullScreen<SDLDrawPlugin32bpp>
    SDLDrawPluginFullScreen32bpp;
typedef SDLDrawPluginFullScreen<SDLDrawPluginPaletaGrises8bpp>
    SDLDrawPluginFullScreenPaletaGrises8bpp;
